...
from src.models.sign_language_model import PlaceholderSignLanguageModel, RealSignLanguageModel
from src.models.text_model import Qwen2LoRAModel

_sign_language_cls: Type[SignLanguageModel] = RealSignLanguageModel
_text_translate_cls: Type[TextTranslateModel] = Qwen2LoRAModel
...
def get_text_translate_model(**kwargs) -> TextTranslateModel:
    ...
    加载 LoRA 权重示例：
        get_text_translate_model(lora_path="models/text_model/lora_word2sent")
    """
